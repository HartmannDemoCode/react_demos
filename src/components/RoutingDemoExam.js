...
const Main = () => (
    <main>
        <Switch>
            ...
            {/* Different way with inline functional component in order to not spread the Route components around inside other components */}
            <Route path='/municipality-board-members-inline-func' render={({props})=>(
                <Switch>
                    <Route exact path='/municipality-board-members-inline-func' component={CandidateList}/>
                    <Route path='/municipality-board-members-inline-func/:id' component={CandidateDetails}/>
                </Switch>    
            )}/>
